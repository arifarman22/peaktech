    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="max-w-7xl mx-auto px-8 pt-32 pb-20">
                {/* Shop Header */}
                <div className="mb-16">
                    <h1 className="text-5xl md:text-6xl font-bold tracking-tight text-[var(--color-primary)] mb-4">
                        Shop
                    </h1>
                    <p className="text-[var(--color-text-muted)] font-medium max-w-2xl text-lg">
